...
public class Day24 {
    private static final ReadLines reader = new ReadLines(2024, 24, 2);

    private static String part1Result;
    private static final ArrayList<Wire> wires = new ArrayList<>();
    private static final ArrayList<Instruction> instructions = new ArrayList<>();
    private static final HashMap<String, Wire> storage = new HashMap<>();
    ...
    public void part1(){
        ...
        System.out.println(binaryAsLong);
    }

    // won't work on sample input
    public void part2(){
        prepare();
        /** switched nodes manually found from the graph png file representing the graph
    ...
    private static void switchWire(int instructionNumberA, int instructionNumberB){
    ...
    private static void determineDifference(){
        ...
        System.out.println(differentDigits + " <- should be 0");

    }

    private static void getGraphValues(){
